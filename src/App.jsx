    ...
    <>
      ...
      <footer className="relative z-10 mt-16 bg-blue-300 gap-4 p-5 flex flex-wrap justify-center items-center">
        ...
        <ul className="grow flex flex-wrap justify-center gap-x-6">
          <li><a className="min-w-max-content text-sm sm:text-base block text-black py-2 rounded px-3 border-blue-700 border-2 transition-colors duration-300 hover:bg-blue-700 hover:text-white" target="_blank" href="https://github.com/BlackBarto">My Github</a></li>
          <li><a className="min-w-max-content text-sm sm:text-base block text-black py-2 rounded px-3 border-blue-700 border-2 transition-colors duration-300 hover:bg-blue-700 hover:text-white" target="_blank" href="https://github.com/BlackBarto/blog-react-router">Source code</a></li>
        </ul>
      </footer>
    </>
  )
